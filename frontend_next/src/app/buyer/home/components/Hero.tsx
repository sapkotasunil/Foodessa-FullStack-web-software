        ...
        <div className=" flex items-center justify-center gap-6 flex-col xl:flex-row">
          ...
          <div className=" flex flex-1 relative z-10 top-12">
            <div className="relative ">
              ...
              {/* Badge */}
              <div className="hidden sm:block absolute top-8 right-14 max-w-48 bg-green-300 shadow-sm pl-2 py-2 rounded-xl">
              ...
              {/* Badge 2 */}
              <div className="hidden sm:block absolute top-52 right-6 max-w-60 bg-green-300 shadow-sm p-2 rounded-xl">
                <div className=" flex gap-2">
              ...
              {/* Badge 3*/}
              <div className="hidden sm:block absolute top-3/4  right-12 max-w-48 bg-green-300 shadow-sm pl-2 py-2 rounded-xl">
                <div className=" flex gap-2">
              ...
              {/* Badge 4*/}
              <div className="hidden sm:block absolute top-28  left-3 max-w-48 bg-green-300 shadow-sm pl-2 py-2 rounded-xl">
                <div className=" flex gap-2">
                  <IoPeopleCircleOutline
                    size={31}
                    className=" text-[#217041]"
                  />
              ...
              {/* Badge 5*/}
              <div className="hidden sm:block absolute bg-green-300 top-72  left-3 max-w-48 bg-light shadow-sm pl-2 py-2 rounded-xl">
                <div className=" flex gap-2">
                  <PiChefHatFill size={27} className=" text-[#217041]" />
                  <h5 className=" text-[14px] md:text-[15px] mb-1 font-bold relative top-1">
                    Exports coocks
                  </h5>
                </div>
