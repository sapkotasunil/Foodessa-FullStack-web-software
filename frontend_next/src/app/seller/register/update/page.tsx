...
import {
  editedSellerData,
  setStatus,
} from "@/lib/store/seller/sellerRegisterSlice";
...
export default function SellerRegistrationForm() {
  ...
  useEffect(() => {
    ...
    if (kitchenDetails.kitchen_name == "") {
      dispatch(getKitchenDetails());
    }
  }, []);
  const [formData, setFormData] = useState({
    kitchen_name: kitchenDetails.kitchen_name,
    kitchen_description: kitchenDetails.kitchen_description,
    kitchen_address: kitchenDetails.kitchen_address,
    phone_number: kitchenDetails.phone_number,
    kitchen_type: "",
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const UpdatedData: any = {
      ...
      kitchen_description: formData.kitchen_description,
    ...
    if (formData.kitchen_profile_photo != null) {
      UpdatedData.kitchen_profile_photo = formData.kitchen_profile_photo;
    }
    if (formData.kitchen_qr_photo != null) {
      UpdatedData.kitchen_qr_photo = formData.kitchen_qr_photo;
    }

    dispatch(editedSellerData(kitchenDetails.id, UpdatedData));
    setLoader(true);
  };
  ...
  useEffect(() => {
    ...
    if (status === "success") {
      SucessfulModel(
        ...
        "Lets start you deal with new Energy"
      );
          ...
          <div className="p-8">
            ...
            >
              ...
              <div className="md:col-span-2">
                ...
                >
                  {loader ? <Loader /> : "Update Kitchen details"}
                </button>
              </div>
            </form>
          </div>
